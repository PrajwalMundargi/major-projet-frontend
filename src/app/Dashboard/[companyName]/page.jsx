...
//       const response = await fetch(
//         `http://127.0.0.1:5000/api/organizations/${encodeURIComponent(
//           companyName
//         )}`
//       );
//       if (!response.ok) throw new Error('Company not found');
...
//       if (data.github_url) {
//         await fetchGitHubIssues(data.github_url);
//       } else {
//         setIssues([]);
//         setFallbackToAll(false);
//       }
...
//       return 'Easy';
//     if (labelNames.some((l) => l.includes('medium') || l.includes('intermediate')))
//       return 'Medium';
//     if (labelNames.some((l) => l.includes('hard') || l.includes('advanced')))
//       return 'Hard';
//     return 'Beginner Friendly';
//   };
...
//   const githubRepos =
//     metrics.github_repos ?? company.github_repos ?? 'N/A';
//   const pullRequests =
//     metrics.pull_requests ?? 'N/A';
//   const mergedPRs =
//     metrics.merged_prs ?? 'N/A';
//   const mergeFrequency =
//     metrics.merge_frequency != null ? metrics.merge_frequency : 'N/A';

//   // ---- simple sample chart data (static) ----
...
//                 </div>
//                 <div className="bg-slate-900/40 border border-slate-700 rounded-xl p-4">
//                   <p className="text-sm text-slate-400 mb-1">Pull Requests</p>
//                   <p className="text-2xl font-semibold text-emerald-400">
//                     {pullRequests}
//                   </p>
//                 </div>
//                 <div className="bg-slate-900/40 border border-slate-700 rounded-xl p-4">
//                   <p className="text-sm text-slate-400 mb-1">Merged PRs</p>
//                   <p className="text-2xl font-semibold text-emerald-400">
//                     {mergedPRs}
//                   </p>
//                 </div>
//                 <div className="bg-slate-900/40 border border-slate-700 rounded-xl p-4">
//                   <p className="text-sm text-slate-400 mb-1">Merge Frequency</p>
//                   <p className="text-2xl font-semibold text-emerald-400">
//                     {mergeFrequency}
//                   </p>
//                 </div>
...
//             <div className="mb-4 text-yellow-300 text-base font-medium">
//               No{' '}
//               <span className="italic text-emerald-400">good first issues</span>{' '}
//               found. Showing latest open issues instead:
//             </div>
//           )}
